...
//import com.golive.component.*;
import com.golive.component.CustomizeDialog;
...
public class ChatListAdapter extends BaseAdapter {
	...
	public ChatListAdapter(GoLiveActivity activity, List<HashMap<String, String>> data) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if ( deltaTime < aDay){
			...
			format = "a hh:mm:ss";
			datelineTV.setText( "¬Q¤Ñ " + getDateTime(format, at ) );
