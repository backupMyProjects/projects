...
import com.golive.*;
import com.golive.task.*;
import com.golive.util.*;
import com.golive.util.AsyncImageLoader.ImageCallback;
...
public class FindFriendAdapter extends BaseAdapter {
	...
	public FindFriendAdapter(GoLiveActivity activity, List<HashMap<String, String>> data) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		dataLayout.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				cf.jump2Activity( GoLiveActivity.class, bundle );
				//--
			}
		});
...
/*
private class DownloadFriendTask extends AsyncTask<Object, Void, ArrayList<HashMap<String, String>>> {
