...
/**
 * Required : barbecue-1.5-beta1.jar
 */
 ...
 * @author leo
 */
public class BarCodeSample_barbecue {

    public static void main(String[] args) throws BarcodeException {
        Barcode barcode = BarcodeFactory.createCode128("Test BarCodeSample_barbecue");

        try {
            File f = new File("d:/mybarcode.png");
